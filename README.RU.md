...
[![🇬🇧 Read in English](https://img.shields.io/badge/%F0%9F%87%AC%F0%9F%87%A7-Read%20in%20English-blue)](./README.md)
...
|---|---|---|
| **🏗️ App** | Собирает всё вместе | Инициализация сервера, DI контейнер, роутер, мидлвары |
...
| **🔧 Shared** | Даёт инструменты | Логгер, драйверы БД, конфиг, HTTP утилиты, чистые хелперы |
...
└── shared/                       # 🔧 Инфраструктура
    ├── api/                      # HTTP примитивы (ошибки, ответы)
...
| Feature → Feature | ❌ Нельзя | Общую логику опускай в Entity |
